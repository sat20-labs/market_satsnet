...
export const WalletDownload: React.FC<WalletDownloadProps> = ({
  className = "",
  iconSize = 22,
  showLabel = false,
}) => {
  return (
    <div className={`w-full ${className}`}>
      {showLabel && (
        <div className="text-[11px] text-zinc-400 mb-1">Wallet Download</div>
      )}
        ...
        {WALLET_ITEMS.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-[13px] font-medium text-zinc-200 group-hover:text-white whitespace-nowrap">
                {item.lines[1]}
              </span>
            </div>
          </a>
